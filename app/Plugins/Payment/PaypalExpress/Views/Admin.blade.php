      ...
      <table class="table table-hover">
         <tbody>
          ...
          <tr>
            ...
            <td><a href="#" class="fied-required editable editable-click" data-name="PaypalExpress_mode" data-type="select" data-pk="PaypalExpress_mode" data-url="{{ sc_route('admin_config.update') }}" data-title="{{ trans($pathPlugin.'::lang.paypal_mode') }}" data-value="{{ sc_config('PaypalExpress_mode') }}" data-source ='[{"value":"sandbox","text":"Sandbox"},{"value":"live","text":"Live"}]'></a></td>
          </tr>

          <tr>
            <th width="40%">{{ trans($pathPlugin.'::lang.paypal_client_id') }}</th>
            <td><a href="#" class="updateData_can_empty editable editable-click" data-name="PaypalExpress_client_id" data-type="text" data-pk="PaypalExpress_client_id" data-url="{{ sc_route('admin_config.update') }}" data-value="{{ sc_config('PaypalExpress_client_id') }}" data-title="{{ trans($pathPlugin.'::lang.paypal_client_id') }}"></a></td>
          </tr>
          <tr>
