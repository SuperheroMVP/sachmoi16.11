...
<head>
    ...
    <link rel="stylesheet" href="{{ asset($sc_templateFile.'/css/bootstrap.min.css')}}">
    <link rel="stylesheet" href="{{ asset($sc_templateFile.'/css/font-awesome.min.css')}}">
    <link rel="stylesheet" href="{{ asset($sc_templateFile.'/css/plugins.css')}}">
    <link rel="stylesheet" href="{{ asset($sc_templateFile.'/css/main.css')}}">
    <style>
        {!! sc_store_css() !!}
    </style>
...
{{--         @section('block_main')
    ...
    <script src="{{ asset($sc_templateFile.'/js/jquery.min.js')}}"></script>
    <script src="{{ asset($sc_templateFile.'/js/bootstrap.bundle.min.js')}}"></script>
    <script src="{{ asset($sc_templateFile.'/js/modernizr-2.8.3.min.js')}}"></script>
    <script src="{{ asset($sc_templateFile.'/js/plugins.js')}}"></script>
    <script src="{{ asset($sc_templateFile.'/js/function.js')}}"></script>
    <script src="{{ asset($sc_templateFile.'/js/main.js')}}"></script>



{{--   <script src="{{ asset($sc_templateFile.'/js/jquery.min.js')}}"></script>
<script src="{{ asset($sc_templateFile.'/js/ajax-mail.js')}}"></script>
<script src="{{ asset($sc_templateFile.'/js/bootstrap.bundle.min.js')}}"></script>
<script src="{{ asset($sc_templateFile.'/js/modernizr-2.8.3.min.js')}}"></script>
<script src="{{ asset($sc_templateFile.'/js/plugins.js')}}"></script>
<script src="{{ asset($sc_templateFile.'/js/function.js')}}"></script>
